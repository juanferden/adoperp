...
?>
<?php 
$strK2LeaveComment = JText::_('K2_LEAVE_A_COMMENT');
if($strK2LeaveComment != "") {
	for($i=0;$i <= strlen($strK2LeaveComment); $i++){
		if(substr($strK2LeaveComment,$i,1) == " "){
			$subK2LeaveComment1 = substr($strK2LeaveComment,0,$i);
			$subK2LeaveComment2 = substr($strK2LeaveComment,$i);
			break;
		}
	}
}
?>
<?php
if($subK2LeaveComment1 != "" && $subK2LeaveComment2 != "") {
?> 
	<h3><?php echo "<span>".$subK2LeaveComment1."</span> ".$subK2LeaveComment2; ?></h3>
<?php
} else {
?>
