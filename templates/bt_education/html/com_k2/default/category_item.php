...
$hasDate = ($this->item->params->get('catItemDateCreated')) ? 'hasDate' : '';
?>
...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
	  ...
	  <!--<div class="bt-ItemImageBlock">-->
		...
		<!-- Date created -->
		<div class="catItemDateCreated blog-created">
		...
		<?php if($this->item->params->get('catItemAuthor') || $this->item->params->get('catItemCategory') || $this->item->params->get('catItemCommentsAnchor')): ?>
	...
	<?php if($this->item->params->get('catItemTitle')): ?>
	  <!-- Item title -->
	  <h3 class="catItemTitle <?php echo $hasDate;?>">
