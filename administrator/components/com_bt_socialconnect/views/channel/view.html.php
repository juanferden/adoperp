...
class Bt_SocialconnectViewChannel extends JViewLegacy
{
	protected $form;	
	protected $item;
	protected $state;
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_BT_BT_SOCIALCONNECT_SYSTEM_CONNECTION_CREATING') : JText::_('COM_BT_BT_SOCIALCONNECT_SYSTEM_CONNECTION_EDITTING'));		
	}
}
