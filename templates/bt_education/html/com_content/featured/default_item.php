...
$addCls  = ($params->get('show_publish_date'))? "hasDate" : "";
?>
...
<?php endif; ?>
  ...
  <dl class="article-info <?php echo $addCls; ?>">
  ...
  <?php if ($params->get('show_publish_date')) : ?>
    <div class="published blog-created">
      <?php //echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', '<span>'.JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC3')).'</span>'); ?>
		<span class="date"><?php echo JHtml::_('date', $this->item->publish_up, 'd') ?></span>
		<span class="month"><?php echo JHtml::_('date', $this->item->publish_up, 'F') ?></span>
	</div>
    <?php endif; ?>
	</div>
  <?php endif; ?>
  ...
  <?php if ($params->get('show_title')) : ?>
	<header class="article-header clearfix">
		<h2 class="article-title pull-left <?php echo $addCls; ?>">
...
<?php endif; ?>
  ...
  <section class="readmore">
    <a class="" href="<?php echo $link; ?>"><span>
