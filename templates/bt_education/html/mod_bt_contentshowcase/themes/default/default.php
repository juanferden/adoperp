			...
			<?php }?>		
				...
				<?php if( $showDate ): ?>
					<span class="bt-date-2">
						...
						<?php // echo JText::sprintf('BT_EDUCATION_BT_CREATEDON', $row->date); ?>
						<span class="bt-date-month"><?php echo JHTML::_('date', $row->created, 'F'); ?></span>
						<span class="bt-date-day"><?php echo JHTML::_('date', $row->created, 'd'); ?></span>
				...
				<div class="bt_inner_infor">
					...
					<?php if($show_category_name_as_link) : ?>
						...
						<div class="bt-extra">
						<?php if( $showAuthor ): ?>
							<span class="bt-author"><?php echo JText::sprintf('BT_EDUCATION_BT_CREATEDBY',JHtml::_('link',JRoute::_($row->authorLink),$row->author)); ?>
							</span>
							<?php endif; ?>
							<?php if( $showDate ): ?>
							<span class="bt-date">
							...
							<?php // echo JText::sprintf('BT_EDUCATION_BT_CREATEDON', $row->date); ?>
							<?php echo JHTML::_('date', $row->created, JText::_('BT_EDUCATION_BT_CREATEDON2')); ?>
							</span>
							<?php endif; ?>
						</div>
						<?php endif; ?>
...
<?php if( $totalLiTags  > 1 ): ?>
    ...
    //    $css.= $moduleCssId. ' .bt-inner .bt-title, '. $moduleCssId . ' .bt-inner .bt-title-nointro, '. $moduleCssId . ' .bt-inner .bt-category, '. $moduleCssId . ' .bt-inner .bt-introtext, ' . $moduleCssId . ' .bt-inner .bt-extra{ margin-' . $align_image . ': '. ($thumbWidth + 10) .'px;} ';
		$css.= $moduleCssId. ' .bt_inner_infor{ margin-' . $align_image . ': '. ($thumbWidth) .'px;} ';
